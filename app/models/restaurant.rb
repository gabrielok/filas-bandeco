class Restaurant < ApplicationRecord
    ...
    # Restaurant.create(name: "Física", website: "http://sites.usp.br/sas/restaurante-da-fisica/", menu: "https://uspdigital.usp.br/rucard/Jsp/cardapioSAS.jsp?codrtn=8")
    ...
    # Restaurant.create(name: "Química", website: "http://sites.usp.br/sas/restaurante-da-quimica/", menu: "https://uspdigital.usp.br/rucard/Jsp/cardapioSAS.jsp?codrtn=9")
end